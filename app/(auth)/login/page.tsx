...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex bg-white">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-[#1e3a8a] to-[#1e40af] text-white flex-col justify-between p-12">
        <div>
          <div className="text-3xl font-bold mb-2">Study++</div>
        </div>

        <div>
          <h1 className="text-5xl font-bold leading-tight mb-6">
            A tua escola organizada, ao teu ritmo
          </h1>
        ...
        <div className="flex items-center gap-4">
          <div className="w-14 h-14 rounded-full bg-gradient-to-br from-pink-400 to-purple-500 flex-shrink-0 flex items-center justify-center text-xl font-bold">
            MJ
          </div>
          <div>
            ...
            <p className="text-blue-200 text-sm">Maria João, Estudante de Design</p>
          </div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex flex-col items-center justify-center px-6 py-12 sm:px-8 lg:px-12">
        <div className="w-full max-w-md">
          ...
          <div className="my-8 flex items-center gap-4">
            ...
            <span className="text-sm text-gray-500 font-medium">OU CONTINUA COM</span>
            <div className="flex-1 h-px bg-gray-200"></div>
          </div>
